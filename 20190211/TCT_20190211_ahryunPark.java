 ...
 *  문제
	...
	메시지가 적들에 의해 조작되어 보내진 것이 아닌 진짜 메시지라는 것을 표시하기 위해 모든 메시지는 변형되는데, 
	이 변형 알고리즘은 메시지를 가로채는 자들이 우연히 변형 규칙을 흉내 낼 수 없을 정도로 정교하다.
	또한 요원들의 머리에 총구가 겨눠져 강제로 메시지를 말한 경우 간단히 실수를 의도적으로 넣어 
	이 메시지가 강제로 쓰인 메시지라는 것을 알려줄 수 있다.
...
public class TCT_20190211_ahryunPark {
	...
	public static void main(String[] args) {
		...
		System.out.println("결과값 1 : " + tct.getReuslt(inputS1));
		System.out.println("결과값 2 : " + tct.getReuslt(inputS2));
		System.out.println("결과값 3 : " + tct.getReuslt(inputS3));
